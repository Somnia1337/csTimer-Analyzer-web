 ...
 * @returns {any}
 */
export function analyze_from_files(options_txt, data_txt) {
    ...
    const ret = wasm.analyze_from_files(ptr0, len0, ptr1, len1);
    if (ret[2]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('cstimer_analyzer_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
